...
from features import TurnBatch, candidate_feature_dim, encode_turn, global_feature_dim, self_feature_dim
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--checkpoint", type=str, default="/home/tts26/sonh/Orbit-Wars-RL/artifacts/rl_template/orbit_wars_template_ppo/ckpt_last.pt")
